...
export default class Particles {
	...
	constructor(webgl,textureContainer) {
		this.webgl = webgl;
		this.textureEl = document.querySelector(textureContainer)
	...
	init(src) {
		...
		loader.load(src, (texture) => {
			...
			// console.log(this.textureEl.clientWidth,this.textureEl.clientHeight)
	...
	show(time = 1.0) {
		// reset
		TweenLite.fromTo(this.object3D.material.uniforms.uSize, time, { value: 0.5 }, { value:0.45 });
